...
// REMOVED: import Notes from '../../components/common/Notes';
// REMOVED: import Chatbot from '../../components/common/Chatbot';
    ...
    return (
        <PageContainer dir={isRTL ? 'rtl' : 'ltr'}>
            ...
            <Title>
                ...
                {currentSubtopic.title} {currentSubtopic.englishTitle && `(${currentSubtopic.englishTitle})`} - 
            ...
            {/* REMOVED: Notes and Chatbot are now rendered in CourseLayout directly */}
            {/* <Notes lessonId={lessonId} /> */}
            {/* <Chatbot courseTopic={parentCourse.topic} courseId={courseId} /> */}
        </PageContainer>
    );
};
