...
const ChatbotContainer = styled.div`
  position: fixed;
  bottom: 20px; /* Adjust from the bottom of the viewport */
  z-index: 1000;
  cursor: pointer;
  ...
  ${({ $isRTL, $fixedOffset = '20px' }) => $isRTL ? css` /* ADDED DEFAULT VALUE HERE */
    left: ${$fixedOffset}; /* In RTL, icons are on the left, offset by fixedSideOffset */
    right: unset;
  ` : css`
    right: ${$fixedOffset}; /* In LTR, icons are on the right, offset by fixedSideOffset */
    left: unset;
  `}
`;
